                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <h1 class="wow fadeInLeft">
                                <br>Hub de Procesos Paris.cl</br>
                            </h1>
                            ...
                            <div class="signup-header wow fadeInUp">
                                ...
                                <form class="form-header" action="../content/" role="form" method="POST" id="#">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control input-lg" name="MERGE0" id="email" type="email" placeholder="correo electrónico" required>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control input-lg" name="MERGE1" id="name" type="password" placeholder="contraseña" required>
                                    </div>
                                    <div class="form-group last">
                                        <input type="submit" class="btn btn-warning btn-block btn-lg" value="INGRESAR">
                                    </div>
                                    <p class="privacy text-center">La información contenida en este sitio es de carácter confidencial.<br><a href="privacy.html">Política de Privacidad</a>.</br></p>
                                </form>
                            </div>				
                ...
                <div class="row row-feat">
                    <div class="col-md-4 text-center">
                        ...
                        <div class="feature-img">
                            <img src="images/micky.jpg" alt="image" class="img-responsive wow fadeInLeft">
                        </div>
                    </div>
